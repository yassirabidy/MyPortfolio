...
const handleGithubClick = (githubLink) => {
  if (githubLink === 'Private') {
    ...
    return false;
  } else if (githubLink === 'No') {
    Swal.fire({
      icon: 'info',
      title: 'No GitHub Repository',
      text: 'There is no GitHub repository available for this project.',
      confirmButtonText: 'Got it',
      confirmButtonColor: '#3085d6',
      background: '#030014',
      color: '#ffffff'
...
const handleLiveDemoClick = (demoLink) => {
  if (demoLink === '') {
    Swal.fire({
      icon: 'info',
      title: 'Live Demo Unavailable',
      text: 'There is no live demo available for this project.',
      confirmButtonText: 'Got it',
      confirmButtonColor: '#3085d6',
      background: '#030014',
      color: '#ffffff'
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || 'https://github.com/yassirabidy',
      };
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-16">
          ...
          <button
            onClick={() => {
              ...
              }, 100); // Timeout to ensure navigation is complete
            }}
